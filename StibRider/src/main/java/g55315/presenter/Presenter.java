...
public class Presenter implements Observer {
   private Model model;
     ...
     */
    public void updateFavoriteName(String name, String origin, String destination,String newName) throws RepositoryException {
        model.updateFavorite(name,origin,destination,newName);
    }
}
