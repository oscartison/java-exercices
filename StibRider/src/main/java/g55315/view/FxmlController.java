...
public class FxmlController implements Initializable {
    ...
    /**
     * clears all the fields on the screen
     * @param e
     * @throws RepositoryException
     */
    @FXML
    public void clearButton(ActionEvent e) throws RepositoryException {
        table.getItems().clear();
        favorites.setValue(null);
        origine.setValue(null);
        destination.setValue(null);
        favoName.setText(null);
    }

    /**
     * updates the name of the favorite
     * @param e
     */
    @FXML
    public void updateFav(ActionEvent e) throws RepositoryException {
        if(favorites.getValue()!= null && origine.getValue()!=null && destination.getValue()!=null && favoName.getText()!=null) {
            presenter.updateFavoriteName(favorites.getValue(), origine.getValue(), destination.getValue(),favoName.getText());
        }
    }
